...
const { AGENT, TOOLS, QUICKSTART, TRANSITION_SCHEMA, ERRORS, serveProtocol } = require("./_lib/settlement-protocol");

// Hobby deployments allow 12 functions. /api/tools.json, /api/openapi.json,
// /api/quickstart.json, /api/schemas/transition.json, and /api/errors.json
