...
The human UI on [`/#activity`](https://liberty-amber.vercel.app/#activity) keeps an append-only list of local demo actions in this browser (`liberty.agent-settlement.activity.v0`): create, fund, submit, release, dispute, simulate, verify, and demo pack import / export / reset. Newest first. Last 80. Job id and `client_ref` appear when present.
