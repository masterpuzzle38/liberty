...
- a `receipt` object shaped like the transition release/dispute receipt (JSON Schema: [`/api/schemas/receipt.json`](api/_lib/receipt.schema.json); a top-level receipt object is also accepted), or
